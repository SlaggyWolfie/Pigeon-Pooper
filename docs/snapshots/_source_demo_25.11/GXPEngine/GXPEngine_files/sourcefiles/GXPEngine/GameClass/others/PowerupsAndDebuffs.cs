...
public abstract class BasePowerup : BasePower
{
    ...
    protected override void Update()
    {
        ...
        {
            SFX.PlaySound(SFX.pickUpPowerUp);
...
public class Food : BasePowerup
{
    ...
    public Food(Level pLevel) : base("assets/powerups_debuffs/pizza_pwrup.png", pLevel)
    {
        _foodEnergy = 25;
    }
...
public class Laxative : BasePowerup
{
    ...
    public Laxative(Level pLevel) : base("assets/powerups_debuffs/dia_pwrup2.png", pLevel)
    {
        SetScaleXY(2f, 2f);
...
public class SpeedUp : BasePowerup
{
    ...
    public SpeedUp(Level pLevel) : base("assets/powerups_debuffs/energy_pwrup.png", pLevel)
    {
...
public class DoublePoints : BasePowerup
{
    ...
    public DoublePoints(Level pLevel) : base("assets/powerups_debuffs/double_pwrup.png", pLevel)
    {
...
public class BeakOfSteel : BasePowerup
{
    ...
    public BeakOfSteel(Level pLevel) : base("assets/powerups_debuffs/beakofsteelnew.png", pLevel)
...
public class Constipation : BaseDebuff
{
    ...
    public Constipation(Level pLevel) : base("assets/powerups_debuffs/cork_dbff.png", pLevel)
    {
...
public class RottenFood : BaseDebuff
{
    ...
    public RottenFood(Level pLevel) : base("assets/powerups_debuffs/rottenpizza_dbff.png", pLevel)
    {
        _foodEnergyLoss = 25;
    }

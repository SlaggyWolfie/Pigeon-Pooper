...
public static class GetAssets
{
    ...
    private static string[] fileDeathPageArray = Directory.GetFiles(@"assets/endscreens/", "*.png");
    ...
    public static string GetCorrectDeathPage(double score)
    {
        string filename;
        if (score <= 10000)
        {
            filename = "assets/endscreens/the_worst_result.png";
            SFX.PlaySound(SFX.applause1);
        }
        else if (score > 10000 && score <= 25000)
        {
            filename = "assets/endscreens/endscreen2.png";
            SFX.PlaySound(SFX.applause3);
        }
        else if (score > 25000)
        {
            filename = "assets/endscreens/endscreen3.png";
            SFX.PlaySound(SFX.applause5);
        }
        else
        {
            filename = "assets/other/white.png";
        }
        return filename;
    }
}

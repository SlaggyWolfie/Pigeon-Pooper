...
public static class ScoreWriter
{
    ...
    private static ScoreParser sp = new ScoreParser();
    private static HighScores hs = sp.Parse("assets/menu/highscores.xml");

    public static void StaticSetScore(string name, double score)
    {
        HighScore newHighScore = new HighScore();
    ...
    public static void StaticWriteScore()
    {
        using (XmlWriter writer = XmlWriter.Create("assets/menu/highscores.xml"))
        {
            writer.WriteStartDocument();
